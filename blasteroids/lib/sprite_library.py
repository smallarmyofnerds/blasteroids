...
class SpriteLibrary:
    ...
    def load_all(self):
        ...
        self.sprites['time_bomb_projectile'] = pygame.transform.scale(self._load_sprite('time_bomb_projectile.png'), (12, 24))
        self.sprites['proximity_mine_projectile'] = pygame.transform.scale(self._load_sprite('proximity_mine_projectile.png'), (24, 24))
