...
class SpaceRocks:
    ...
    def __init__(self, size = (1800 , 1000)):
        ...
        self.ship_2_move = [pygame.image.load("assets/sprites/ship_2_move_1.png"), pygame.image.load("assets/sprites/ship_2_move_2.png"), pygame.image.load("assets/sprites/ship_2_move_3.png")]
        self.move_count = 0
    ...
    def new_game(self):
        ...
        self.spaceship = Spaceship(
            (400, 300),
            load_sprite("Ship_LVL_2"), 
            [
                pygame.image.load("assets/sprites/ship_2_move_1.png"), 
                pygame.image.load("assets/sprites/ship_2_move_2.png"), 
                pygame.image.load("assets/sprites/ship_2_move_3.png"),
                pygame.image.load("assets/sprites/ship_2_move_2.png"),
            ] ,
            self.bullets.append)
        self.new_rocks()
